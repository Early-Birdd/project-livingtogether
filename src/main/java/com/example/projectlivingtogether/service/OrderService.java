...
import com.example.projectlivingtogether.dto.OrderHistoryDto;
import com.example.projectlivingtogether.dto.OrderItemDto;
import com.example.projectlivingtogether.entity.*;
    ...
    public Page<OrderHistoryDto> getOrderList(String email, Pageable pageable){
        ...
        for(Order order : orders){
            ...
            for(OrderItem orderItem : orderItems){
                ...
                ItemImage itemImage = itemImageRepository.findByItemIdAndRpImage(orderItem.getItem().getId(), "Y");
