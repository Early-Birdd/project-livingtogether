...
import com.example.projectlivingtogether.dto.CartOrderDto;
import com.example.projectlivingtogether.service.CartService;
...
public class CartController {
    ...
    public @ResponseBody ResponseEntity updateCartItem(@PathVariable("cartItemId") Long cartItemId, int count, Principal principal){
        ...
        if(count <= 0){
            ...
            return new ResponseEntity<String>("상품을 1개 이상 담아주십시오.", HttpStatus.BAD_REQUEST);
    ...
    public @ResponseBody ResponseEntity orderCartItem(@RequestBody CartOrderDto cartOrderDto, Principal principal){
        ...
        if(cartOrderDtoList == null || cartOrderDtoList.size() == 0){
            ...
            return new ResponseEntity<String>("주문할 상품을 선택하십시오.", HttpStatus.FORBIDDEN);
        }
